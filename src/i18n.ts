...
const strings = {
  zh: {
    ...
    settings: {
      ...
      cloudSync: "云同步",
      cloudSyncCopy: "可选：使用一段长同步码在多台设备间同步任务。同步码等同于访问密钥，请不要公开。",
      supabaseUrl: "Supabase Project URL",
      supabaseAnonKey: "Supabase anon key",
      syncCode: "同步码",
      generateSyncCode: "生成同步码",
      confirmGenerateSyncCode: "再次点击“确认生成”会替换当前同步码。旧同步码对应的云端数据不会自动迁移。",
      confirmGenerateSyncCodeButton: "确认生成",
      copySyncCode: "复制同步码",
      showSyncAdvanced: "高级配置",
      hideSyncAdvanced: "收起高级",
      syncCodeGenerated: "已生成新的同步码",
      syncCodeCopied: "同步码已复制",
      syncCodeCopyFailed: "同步码复制失败",
      syncEmail: "邮箱",
      syncPassword: "密码",
      saveSyncConfig: "保存同步配置",
      syncConfigSaved: "同步配置已保存",
      syncConfigFailed: "同步配置保存失败",
      syncSignUp: "注册",
      syncSignUpDone: "注册已提交，如项目开启邮件验证，请先确认邮件",
      syncSignUpFailed: "注册失败",
      syncSignIn: "登录",
      syncSignedIn: "已登录同步账号",
      syncSignInFailed: "登录失败",
      syncSignedInAs: "已登录：",
      syncSignOut: "登出",
      syncSignedOut: "已退出同步账号",
      syncSignOutFailed: "登出失败",
      syncNow: "立即同步",
      syncingNow: "正在同步...",
      syncDone: "同步完成",
      syncFailed: "同步失败，请检查 Supabase 配置和 RLS 表"
    },
    import: {
      title: "导入",
...
6. 标题保持简短，去掉无关说明。`
  ...
  ja: {
    ...
    settings: {
      ...
      cloudSync: "クラウド同期",
      cloudSyncCopy: "任意: 長い同期コードで複数端末のタスクを同期します。同期コードはアクセスキーと同じなので公開しないでください。",
      supabaseUrl: "Supabase Project URL",
      supabaseAnonKey: "Supabase anon key",
      syncCode: "同期コード",
      generateSyncCode: "同期コードを生成",
      confirmGenerateSyncCode: "もう一度「生成を確認」をクリックすると現在の同期コードが置き換わります。旧コードのクラウドデータは自動移行されません。",
      confirmGenerateSyncCodeButton: "生成を確認",
      copySyncCode: "同期コードをコピー",
      showSyncAdvanced: "詳細設定",
      hideSyncAdvanced: "詳細を閉じる",
      syncCodeGenerated: "新しい同期コードを生成しました",
      syncCodeCopied: "同期コードをコピーしました",
      syncCodeCopyFailed: "同期コードのコピーに失敗しました",
      syncEmail: "メール",
      syncPassword: "パスワード",
      saveSyncConfig: "同期設定を保存",
      syncConfigSaved: "同期設定を保存しました",
      syncConfigFailed: "同期設定の保存に失敗しました",
      syncSignUp: "登録",
      syncSignUpDone: "登録しました。メール確認が有効な場合は先に確認してください",
      syncSignUpFailed: "登録に失敗しました",
      syncSignIn: "ログイン",
      syncSignedIn: "同期アカウントにログインしました",
      syncSignInFailed: "ログインに失敗しました",
      syncSignedInAs: "ログイン中:",
      syncSignOut: "ログアウト",
      syncSignedOut: "同期アカウントからログアウトしました",
      syncSignOutFailed: "ログアウトに失敗しました",
      syncNow: "今すぐ同期",
      syncingNow: "同期しています...",
      syncDone: "同期しました",
      syncFailed: "同期に失敗しました。Supabase 設定と RLS テーブルを確認してください"
    },
    import: {
      title: "インポート",
      copyPrompt: "認識 Prompt をコピー（外部AIで取込コード化）",
      exportJson: "JSON 出力",
      importJson: "JSON 読込",
...
6. タイトルは短く、不要な説明を除いてください。`
  ...
  en: {
    ...
    settings: {
      ...
      hide30: "Hide 30 min",
      hide60: "Hide 60 min",
      hideTemporary: "Hide temporarily",
      dataDir: "Data folder",
      backup: "Back up DB",
      ...
      cloudSyncCopy: "Optional: sync tasks across devices with a long sync code. Treat it like an access key.",
      supabaseUrl: "Supabase Project URL",
      supabaseAnonKey: "Supabase anon key",
      syncCode: "Sync code",
      generateSyncCode: "Generate sync code",
      confirmGenerateSyncCode: "Click Confirm generate again to replace the current sync code. Cloud data under the old code will not be migrated automatically.",
      confirmGenerateSyncCodeButton: "Confirm generate",
      copySyncCode: "Copy sync code",
      showSyncAdvanced: "Advanced config",
      hideSyncAdvanced: "Hide advanced",
      syncCodeGenerated: "New sync code generated",
      syncCodeCopied: "Sync code copied",
      syncCodeCopyFailed: "Could not copy sync code",
      syncEmail: "Email",
      syncPassword: "Password",
      saveSyncConfig: "Save sync config",
      syncConfigSaved: "Sync config saved",
      syncConfigFailed: "Could not save sync config",
      syncSignUp: "Sign up",
      syncSignUpDone: "Sign-up submitted. Confirm your email first if your project requires it",
      syncSignUpFailed: "Sign-up failed",
      syncSignIn: "Sign in",
      syncSignedIn: "Signed in for sync",
      syncSignInFailed: "Sign-in failed",
      syncSignedInAs: "Signed in:",
      syncSignOut: "Sign out",
      syncSignedOut: "Signed out from sync",
      syncSignOutFailed: "Sign-out failed",
      syncNow: "Sync now",
      syncingNow: "Syncing...",
      syncDone: "Sync complete",
      syncFailed: "Sync failed. Check the Supabase config and RLS table"
    },
    import: {
      title: "Import",
      copyPrompt: "Copy recognition prompt (external AI to import code)",
